package biz.sendyou.senduandroid.Util.billing;
...
public abstract class cInAppBillingHelper {
    ...
    private final String LOGTAG = "cInAppBillingHelper";
    ...
    ServiceConnection mServiceConn = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            Log.d("cInAppBillingHelper", "service connected");
        }

        @Override
        public void onServiceDisconnected(ComponentName name) {
            mService = null;
            Log.d("cInAppBillingHelper", "service disconnected");
        }
    };
        ...
        mHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
            ...
            public void onIabSetupFinished(IabResult result) {
                if (!result.isSuccess()) {
                    ...
                    Log.i(LOGTAG, "startSetup failed");
                    Log.i(LOGTAG, "IabResult : " + result.getMessage());
    ...
    public void AlreadyPurchaseItems() {
        Log.i(LOGTAG, "AlreadyPurchaseItems");
        try {
